        ...
        private const string TerminalHtml = """
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            (function () {
              ...
              window.PS7ScriptDeskTerminalSpike = {
                write: function (data) {
              ...
              window.chrome.webview.addEventListener('message', function (event) {
                try {
                  ...
                  if (message.type === 'output_b64' && typeof message.data === 'string') {
                    window.PS7ScriptDeskTerminalSpike.write(decodeBase64Utf8(message.data));
                  } else if (message.type === 'output' && typeof message.data === 'string') {
                    window.PS7ScriptDeskTerminalSpike.write(message.data);
                  } else if (message.type === 'clear') {
                    window.PS7ScriptDeskTerminalSpike.clear();
                  } else if (message.type === 'focus') {
                    focusTerminal('host.focus');
                  } else if (message.type === 'paste' && typeof message.data === 'string' && message.data.length > 0) {
                    window.PS7ScriptDeskTerminalSpike.paste(message.data);
                  }
                } catch (error) {
