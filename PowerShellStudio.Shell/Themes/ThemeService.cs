...
namespace PowerShellStudio.Shell.Themes
{
    /// <summary>
    ...
    public sealed class ThemeService
    {
        ...
        private const string ThemeDictionarySource = "pack://application:,,,/PowerShellStudio.Shell;component/Themes/{0}Theme.xaml";
